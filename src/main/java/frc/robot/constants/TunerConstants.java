...
public class TunerConstants {
    ...
    public static final CANBus kCANBus = new CANBus("The_Silly", "./logs/example.hoot");
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.223876953125);
